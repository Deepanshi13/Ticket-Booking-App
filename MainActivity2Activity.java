...
public class MainActivity2Activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("dd","msg"+Globals.getTranslation("APP_TITLE"));
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        this.getSupportActionBar().setHomeAsUpIndicator(R.drawable.menu_icon);
...
//            mPreview = new CameraPreview(this, mCamera, previewCb, autoFocusCB);
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.container, ScannerFragment1.newInstance("",""))
    ...
    public void scanned(String res){
        scannedData = res;
